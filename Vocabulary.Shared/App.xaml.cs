...
namespace Vocabulary
{
    ...
    {
        private Guid APP_ID = new Guid("daaa6bd3-8302-4ae4-b113-b57bf53149cb");
        public const string APP_NAME = "Vocabulary";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"Norwegian Vocabulary", @"Velkommen!");
